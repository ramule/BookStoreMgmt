...
/**
 * Generated class for the ChildrenBookPage page.
 *
...
// @IonicPage()
@Component({
  selector: 'page-children-book',
  templateUrl: 'children-book.html',
})
export class ChildrenBookPage {
  childrenBook : any = []
  data : any =[]
  customerId : any 
...
public loading : LoadingController ) {
      this.fb.getChildrenBooks().subscribe(res =>{
        this.PresentLoader();
        this.childrenBook = res
      })
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ChildrenBookPage');
  }
