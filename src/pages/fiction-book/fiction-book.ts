...
/**
 * Generated class for the FictionBookPage page.
 *
...
// @IonicPage()
@Component({
  selector: 'page-fiction-book',
  templateUrl: 'fiction-book.html',
})
export class FictionBookPage {
  fictionBook : any = []
  data : any =[]
  customerId : any
  ...
  public loading : LoadingController) {
    this.fb.getFictionBooks().subscribe(res =>{
      this.PresentLoader()
      this.fictionBook = res;
    })
  }
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FictionBookPage');
  }
